...
def musicSeperation(wav_path, output_path):
    ...
    # save as files
    # torchaudio.save("drums.wav", audios["drums"].cpu(), sample_rate)
    # torchaudio.save("bass.wav", audios["bass"].cpu(), sample_rate)
    # torchaudio.save("other.wav", audios["other"].cpu(), sample_rate)
